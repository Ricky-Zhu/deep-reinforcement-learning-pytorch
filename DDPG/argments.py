...
def get_args():
    ...
    parse.add_argument('--a-lr', type=float, default=1e-4, help='the lr of the actor')
    parse.add_argument('--c-lr', type=float, default=1e-3, help='the lr of the critic')
    ...
    parse.add_argument('--nb-cycles', type=int, default=3)
    parse.add_argument('--nb-train', type=int, default=50, help='number to train the agent')
    parse.add_argument('--nb-rollout-steps', type=int, default=128, help='steps to collect samples')
    parse.add_argument('--nb-test-rollouts', type=int, default=10, help='the number of test')
    parse.add_argument('--batch-size', type=int, default=64, help='the batch size to update network')
